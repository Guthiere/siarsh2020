<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="username" type="text" class="block w-full mt-1" wire:model.defer="state.username" autocomplete="username" readonly />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="dni" type="number" class="block w-full mt-1" wire:model.defer="state.dni" autocomplete="dni" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="phone" type="number" class="block w-full mt-1" wire:model.defer="state.phone" autocomplete="phone" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="institution" type="text" class="block w-full mt-1" wire:model.defer="state.institution" autocomplete="institution" />
